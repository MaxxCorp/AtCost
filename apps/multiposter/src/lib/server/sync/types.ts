...
export type ProviderType = 'google-calendar' | 'microsoft-calendar' | 'webhook' | 'custom' | 'berlin-de-main-calendar' | 'berlin-de-mh-calendar' | 'wp-the-events-calendar' | 'eventbrite' | 'meetup' | 'seniorennetz-berlin' | 'bewegungsatlas-berlin' | 'email' | 'nebenan-de';
