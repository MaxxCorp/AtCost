...
declare global {
    ...
    var __ac_redis_client: Redis | null | undefined;
}
...
export function getRedisClient(): Redis | null {
    if (globalThis.__ac_redis_client !== undefined) {
        return globalThis.__ac_redis_client;
    }
    ...
    if (!redisUrl || redisUrl.trim() === '') {
        ...
        globalThis.__ac_redis_client = null;
        return null;
    }
    ...
    try {
        ...
        globalThis.__ac_redis_client = client;
        if (!loggedInit) {
